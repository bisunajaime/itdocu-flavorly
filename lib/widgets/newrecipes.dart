                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      CircleAvatar(
                        backgroundImage:
                            AssetImage(data[rng.nextInt(6)].user.profileImg),
                        radius: 20,
                      ),
                      SizedBox(
                        width: 5.0,
                      ...
                      Column(
                        ...
                        children: <Widget>[
                          Text(
                            data[rng.nextInt(6)].user.name.split(" ")[0],
                            style: TextStyle(
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                data[rng.nextInt(6)].cuisineType,
                                style: TextStyle(
